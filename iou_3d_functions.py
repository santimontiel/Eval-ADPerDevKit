...
def box3d_iou(corners1, corners2, criterion='union'):
    ...
    '''
    # corner points area in counter clockwise order
...
def compute_box_3d(obj):
    # TODO: h is along y-axis
    ''' Takes an object [x,y,z,w,h,l,yaw] (Camera frame) 
        Returns:
...
def compute_box_3d_pandas(row):
    ...
    corners_3d = np.dot(R, np.vstack([x_corners,y_corners,z_corners]))
    #print corners_3d.shape
    corners_3d[0,:] = corners_3d[0,:] + row['x']
    corners_3d[1,:] = corners_3d[1,:] + row['y']
    corners_3d[2,:] = corners_3d[2,:] + row['z']
    # print('cornsers_3d: ', corners_3d)
...
if __name__=='__main__':
    aa  = ((1.497255,1.644981, 3.628938), -1.531692, (1.2, 1.56, 23.56)) 
    bb  = ((1.458242, 1.604773, 3.707947), -1.549553, (1.37, 1.67, 29.57))

    iou3d = box3doverlap(aa,bb)
    print("IoU 3D: ", iou3d)
